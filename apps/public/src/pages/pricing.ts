...
<style>
  ...
  .plan-btn { display: block; width: 100%; text-align: center; padding: 0.875rem; border-radius: 12px; font-size: 0.9375rem; font-weight: 600; transition: all 0.15s; }
...
<div class="pricing-grid">
  ...
  <div class="plan-card popular">
    ...
    <p class="plan-price">2,900원 <span>/ 월</span></p>
    ...
    <a href="${ADMIN_URL}/login" class="plan-btn plan-btn-primary">Pro 시작하기</a>
  </div>
...
export const pricingHtml = layout(
  "요금제 - PromoBuilder",
  "무료로 시작하고, 필요할 때 업그레이드하세요. 월 2,900원으로 더 많은 기능을 사용할 수 있습니다.",
  body
);
